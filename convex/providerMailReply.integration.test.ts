...
async function fixture(options: { decline?: boolean } = {}) {
  ...
  const ids = await t.run(async (ctx) => {
    ...
    const assessment: ProviderAssessment = options.decline
      ? { summary: "The provider cannot meet the required schedule.", availability: { status: "unknown", evidence: [] }, monthlyPrice: { totalEur: null, allRecurringCostsKnown: false, evidence: [] }, terms: [], constraints: [], uncertainties: [], contradictions: [], nextAction: "decline", suggestedReply: { subject: "Re: Room", body: "Thanks, but the schedule does not fit." }, viewing: null }
      : { summary: "Ask about Tuesday", availability: { status: "unknown", evidence: [] }, monthlyPrice: { totalEur: null, allRecurringCostsKnown: false, evidence: [] }, terms: [], constraints: [], uncertainties: ["Tuesday"], contradictions: [], nextAction: "ask_provider", suggestedReply: { subject: "Re: Room", body: "Would Tuesday evening work?" }, viewing: null };
