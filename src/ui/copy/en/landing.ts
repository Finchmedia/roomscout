...
export const landingEn = {
  ...
  coverage: {
    eyebrow: "Rehearsal rooms found",
    title: "Rooms found on public rehearsal-space websites",
    lead: "See where RoomScout has found real rehearsal rooms and which public websites they came from.",
    realCountLabel: "real rehearsal rooms found",
    observedLabel: "Last checked",
    mapLabel: "Map of real rehearsal rooms found in Germany",
    mapLoading: "Loading the research map…",
    mapUnavailable: "The map is currently unavailable.",
    empty: "There are currently no real rehearsal rooms listed here.",
    sourcesTitle: "Where these rooms were found",
    indexedSource: "Public source",
    noSources: "No public source links are available yet.",
    contactDisabled: "RoomScout does not contact real providers during this demo. A room shown here may no longer be available.",
    demoCta: "Try fictional rooms in Berlin →",
  },
  control: {
