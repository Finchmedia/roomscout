...
export const liveScoutDe = {
  ...
  candidatesEmpty: "Noch keine passenden Räume. Ich suche weiter.",
  showAboveBudget: "Räume über Budget anzeigen",
  candidateGroups: {
    active: "Weiter im Rennen",
    aboveBudget: "Über Budget",
    notFit: "Nicht mehr passend",
  },
  ...
  candidateState: {
    ...
    notFit: "Nicht mehr passend",
    scheduleConflict: "Zeiten passen nicht",
    requirementsConflict: "Anforderungen passen nicht",
  },
  candidatePanel: {
    room: "Raumdetails",
    fit: "Möglicherweise passend",
    nearBudget: "Über eurem aktuellen Budget",
    reasons: "Warum der Raum passen könnte",
    uncertainties: "Noch zu klären",
    adjustBudget: "Suchbudget anpassen",
    contact: "Diesen Anbieter anfragen",
    openConversation: "Unterhaltung öffnen",
    backToRoom: "Zurück zu den Raumdetails",
    retry: "Prüfung wiederholen",
    monthlyPrice: "{amount} / Monat",
    minimumPrice: "Mindestens {amount} / Monat",
    budgetGap: "{amount} über eurem Monatsbudget",
    minimumBudgetGap: "Mindestens {amount} über eurem Monatsbudget",
    actionQueued: "Dieser Raum wird geprüft …",
    actionUnavailable: "Dieser Raum kann noch nicht kontaktiert werden. Prüft den aktuellen Suchauftrag und die Verbindung.",
    contactDisabledDemo: "Kontakt in der Demo deaktiviert",
    profileRequired: "Vervollständige zuerst dein Musikerprofil, bevor dein Scout Anbieter kontaktiert.",
  },
  profileIncomplete: {
    title: "Vervollständige dein Musikerprofil, bevor dein Scout Anbieter kontaktiert.",
  ...
  decisionNext: "Nächste Frage",
  decisionQuestionProgress: "Frage {current} von {total}",
  decisionRequired: "Wähl eine Antwort oder schreib deine eigene.",
  decisionScopes: "Betroffene Angaben",
  decisionSubject: "Betreff",
  decisionMessage: "So würde ich schreiben:",
  decisionQuestion: {
    review_message: "Soll ich diese Nachricht so senden?",
    ...
    binding_content: "Diese Nachricht braucht deine ausdrückliche Freigabe. Soll ich sie senden?",
    ...
    safety_unavailable: "Ich konnte die Nachricht nicht prüfen. Soll ich sie trotzdem senden?",
  },
